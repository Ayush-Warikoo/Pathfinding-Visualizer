    ...
    <div className="Header">
      <div className="Header__Top">
        ...
        <div className="Header__RunProgram">
          <button
            disabled={!algorithm}
            onClick={() => algorithmManager(grid, algorithm)}
          >
      ...
      <div className="Header__Bottom">
        <div
          className={
            "Header__PathCells" + setSelectedTitleClass(PATH_CELLS_TITLE)
          }
        >
          ...
          <div
            className={
              "Header__FinishCell" + setSelectedStateClass(FINISH_STATE)
            }
        ...
        <div className={"Header__Walls" + setSelectedTitleClass(WALLS_TITLE)}>
          ...
          <div
            className={
              "Header__CellWall" + setSelectedStateClass(CELL_WALL_STATE)
            }
          ...
          <div
            className={
              "Header__BorderWall" + setSelectedStateClass(BORDER_WALL_STATE)
            }
        ...
        <div
          className={"Header__Weights" + setSelectedTitleClass(WEIGHTS_TITLE)}
        >
          ...
          <div
            className={
              "Header__WeightOne" + setSelectedStateClass(WEIGHT_ONE_STATE)
            }
          ...
          <div
            className={
              "Header__WeightTwo" + setSelectedStateClass(WEIGHT_TWO_STATE)
            }
